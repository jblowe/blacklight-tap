...
perl -i -n  addtitle.pl ../tap-solr-data/TAP86_bags.csv
perl -i -n  addtitle.pl ../tap-solr-data/TAP90_bags.csv
perl -i -n  addtitle.pl ../tap-solr-data/TAP92_bags.csv
perl -i -n  addtitle.pl ../tap-solr-data/TAP94_bags.csv
